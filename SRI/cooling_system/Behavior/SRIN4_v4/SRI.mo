...
model SRI "SRI built with ThermoSysPro v4.0"
  ...
  ThermoSysPro.WaterSteam.PressureLosses.LumpedStraightPipe PerteDP2(
    ...
    C1(h_vol(start=71612.6), P(start=323241)))
          ...
          rotation=0)));
  SRIN4_v3.CmdVannes cmdVannes(consigneT=290.15, Ti=8) annotation (Placement(
        transformation(origin={-282,168}, extent={{-38,-37},{38,37}})));
  ...
  Verification.Scenarios.Connector.BooleanExpression ouvreBranche2(y=scenario.ouvreBranche2)
    annotation (Placement(transformation(origin = {-2, 0}, extent = {{-438, 24}, {-418, 44}})));
...
equation
  ...
  connect(CapteurT1.C2, PerteDP2.C1) annotation (
    Line(points = {{-130, 10}, {-100, 10}}, color = {0, 0, 255}));
  ...
  connect(CapteurT1.Measure, cmdVannes.utemp) annotation (Line(points={{-140,28},
          {-140,236},{-336,236},{-336,195.133},{-321.9,195.133}}, color={0,0,
          255}));
  connect(and1.yL, cmdVannes.unbech) annotation (Line(points={{-379,62},{-376,
          62},{-376,140.867},{-321.9,140.867}}, color={0,0,255}));
  connect(ouvreBranche2.yL, and1.uL2) annotation (Line(points={{-419,34},{-412,
          34},{-412,56},{-401,56}},
                                color={0,0,255}));
  connect(ouvreBranche2.yL, VanneTOR0_2.Ouv)
    annotation (Line(points={{-419,34},{-330,34},{-330,23}}, color={0,0,255}));
  ...
  connect(cmdVannes.ybypass, VanneBypass.Ouv) annotation (Line(points={{-242.1,
          140.867},{-232,140.867},{-232,-37},{-210,-37}}, color={0,0,255}));
  connect(cmdVannes.yserie, VanneSerie1.Ouv) annotation (Line(points={{-242.1,
          195.133},{-224,195.133},{-224,194},{-210,194},{-210,87}}, color={0,0,
          255}));
  connect(cmdVannes.yserie, VanneSerie2.Ouv) annotation (Line(points={{-242.1,
          195.133},{-218,195.133},{-218,194},{-196,194},{-196,36},{-210,36},{
          -210,27}}, color={0,0,255}));
  ...
  annotation (
    Diagram(coordinateSystem(preserveAspectRatio=false, extent = {{-500, 340}, {300, -200}},
        grid={2,2},
        initialScale=0.1)),
